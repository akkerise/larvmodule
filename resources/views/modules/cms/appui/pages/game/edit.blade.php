...
<div id="page-content">
    ...
    <div class="block full">
        ...
        <div>
            <form id="game-add-form-post" action="{{ route('cms.p.game.edit', $game->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                {{ method_field('PUT') }}
                @csrf
                <div class="form-group">
                    <label class="col-md-3 control-label" for="name">Name</label>
                    <div class="col-md-8">
                        <input type="text" value="{{ $game->name }}" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Name">
                        @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea id="description" name="description" rows="5" cols="47" class="form-control" value="{{ old('description') }}" placeholder="Description..">{{ $game->description }}</textarea>
