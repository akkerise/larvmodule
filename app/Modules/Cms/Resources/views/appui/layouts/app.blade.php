...
<script src="{{ asset('appui/js/fly.js') }}"></script>
<script src="{{ asset('appui/js/ejs.js') }}"></script>
<script src="{{ asset('appui/js/tmpl.js') }}"></script>
<script src="{{ asset('appui/js/popup.js') }}"></script>
<script src="{{ asset('appui/js/croppie.js') }}"></script>
<script src="{{ asset('appui/js/media.js') }}"></script>  
@yield ('scripts')
<script>
    var baseUrl = @json(config('cms.baseUrl'));
</script>
</body>
</html>
