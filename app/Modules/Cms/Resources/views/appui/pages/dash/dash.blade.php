                    ...
                    <div class="widget-content widget-content-full">
                        <div class="row text-center">
                            ...
                            <div class="col-xs-4 push-inner-top-bottom border-left">
                                <h3 class="widget-heading"><i class="gi gi-life_preserver text-dark push-bit"></i> <br>
            ...
            <div class="col-sm-6 col-lg-4">
                ...
                <a href="page_ready_profile.html" class="widget">
                    ...
                    <div class="widget-content border-bottom text-center themed-background-muted">
                        <img src="{{ asset('appui/img/placeholders/avatars/avatar13@2x.jpg') }}" alt="avatar"
                    ...
                    <div class="widget-content widget-content-full-top-bottom">
                        <div class="row text-center">
                            <div class="col-xs-6 push-inner-top-bottom border-right">
                                <h3 class="widget-heading"><i class="gi gi-briefcase text-dark push-bit"></i> <br>
                                    <small>35 Projects</small>
                                </h3>
                            </div>
                            <div class="col-xs-6 push-inner-top-bottom">
                                <h3 class="widget-heading"><i class="gi gi-heart_empty text-dark push-bit"></i> <br>
            ...
            <div class="col-sm-4">
                ...
                <div class="widget">
                    ...
                    <a href="javascript:void(0)" class="widget-content themed-background-muted text-right clearfix">
                        <img src="{{ asset('appui/img/placeholders/avatars/avatar6.jpg') }}" alt="avatar"
                    ...
                    <a href="javascript:void(0)"
                       class="widget-content themed-background-muted border-top text-right clearfix">
                        <img src="{{ asset('appui/img/placeholders/avatars/avatar2.jpg') }}" alt="avatar"
                             class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
                    ...
                    <a href="javascript:void(0)"
                       class="widget-content themed-background-muted border-top text-right clearfix">
                        <img src="{{ asset('appui/img/placeholders/avatars/avatar11.jpg') }}" alt="avatar"
                             class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
            ...
            <div class="col-sm-4">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content widget-content-full">
                        <div class="row text-center">
                            <div class="col-xs-6 push-inner-top-bottom border-right">
                                <h3 class="widget-heading"><i class="gi gi-briefcase text-dark push"></i> <br>
                                    <small>5 Products</small>
                                </h3>
                            </div>
                            <div class="col-xs-6 push-inner-top-bottom">
                                <h3 class="widget-heading"><i class="gi gi-truck text-dark push"></i> <br>
                                    <small>10 Deliveries</small>
                                </h3>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="widget">
                    ...
                    <div class="widget-image">
                        <img src="{{ asset('appui/img/placeholders/photos/photo9.jpg') }}" alt="image">
                        <div class="widget-image-content">
                            <h2 class="widget-heading"><a href="page_ready_article.html" class="text-light"><strong>The
                                        trip that changed my life</strong></a></h2>
...
<script src="{{ asset('appui/js/pages/readyDashboard.js') }}"></script>
