...
@section('content')
    ...
    <div id="login-container">
        ...
        <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
            <i class="fa fa-cube"></i> <strong>Welcome to <br> h5 Portal Manager System</strong>
        </h1>
        <!-- END Login Header -->
        ...
        <div class="block animation-fadeInQuickInv">
            ...
            <form id="form-login" action="{{ url('cms/login') }}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <input type="text" id="login-email" name="email" value="{{ old('email') }}" class="form-control" placeholder="Your email..">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
